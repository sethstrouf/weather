...
function App() {
  ...
  const handleSubmit = (event) => {
    ...
    axios(
      `https://api.weatherapi.com/v1/forecast.json?key=${process.env.REACT_APP_API_KEY}&q=${zipcode}&days=2&aqi=no&alerts=no`
    )
      .then((response) => {
  ...
  return (
    <div
      className="text-center typography text-gray-800 bg-gray-50
                    sm:text-lg lg:text-xl 2xl:text-2xl"
    >
      <div
        className="pt-4 sm:pt-8 lg:pt-12 min-h-screen relative mx-auto 
